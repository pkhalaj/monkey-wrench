...
from monkey_wrench.datetime_utils import Order
from monkey_wrench.process_utils import run_multiple_processes
from monkey_wrench.query_utils import Results
...
def create_datetime_directory(
    ...
    Example:
        >>> from datetime import datetime
        >>> from pathlib import Path
        >>> from monkey_wrench.io_utils import create_datetime_directory
        >>> home = Path.home()
...
def compare_files_against_reference(
    ...
    Args:
        ...
        transform_function:
            ...
            e.g. a :func:`~monkey_wrench.datetime_utils.DateTimeParser.parse` function to make datetime objects out of
        ...
        number_of_processes:
            The number of processes used to get the size of files concurrently. Defaults to ``20``. A value of ``1``
