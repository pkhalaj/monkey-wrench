"""The module which defines common functionalities needed in the :obj:`datetime_utils` package."""
...
def number_of_days_in_month(year: PositiveInt, month: PositiveInt) -> int:
    ...
    Example:
        >>> from monkey_wrench.datetime_utils import number_of_days_in_month
...
def floor_datetime_minutes_to_snapshots(snapshots: list[Minutes], datetime_instance: datetime) -> datetime:
    ...
    Example:
          ...
          >>> from monkey_wrench.datetime_utils import floor_datetime_minutes_to_snapshots
