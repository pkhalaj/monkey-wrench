"""The module to provide functionalities for processes and multiprocessing."""
...
def run_multiple_processes(
    ...
    Args:
        ...
        number_of_processes:
            Number of processes to use. Defaults to ``2``.
        temp_directory:
    ...
    """
    with io_utils.temp_directory(temp_directory):
